            ...
            <div class="tab-content">
              ...
              <div class="tab-pane container fade" id="donors">
                ...
                <form action="file/donorReg.php" method="post" enctype="multipart/form-data">
                  ...
                  <input type="tel" name="dphone" placeholder="Donor Phone Number" class="form-control mb-3" required pattern="[0,6-9]{1}[0-9]{9,11}" title="Password must have start from 0,6,7,8 or 9 and must have 10 to 12 digit">
