        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <?php if (isset($_SESSION['hid'])) { ?>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="camp1.php"> update Camp details</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="stock.php">stock</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="donorrequest.php">Donors Request</a>
                    </li>
                    <li class="nav-item">
            ...
            <?php } elseif (isset($_SESSION['rid'])) { ?>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link btn btn-light" href="sentrequest1.php">Sent Donor Request</a>
                    </li> -->
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="abs1.php">Available Donors</a>
                    </li>
                    <li class="nav-item">
            ...
            <?php } elseif (isset($_SESSION['did'])) { ?>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="campdis.php">Camp</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="sentrequest1.php">Blood Request</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="availablehospitals.php">Available Hospitals</a>
                    </li>
                    <li class="nav-item">
