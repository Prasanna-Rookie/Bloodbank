				...
				<div class="card">
					...
					<div class="card-body">
					   <form action="file/updateprofile.php" method="post">
						...
						<input type="text" name="dname" value="<?php echo $row['dname']; ?>" class="form-control mb-3" required>
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Donor Email</label>
						<input type="email" name="demail" value="<?php echo $row['demail']; ?>" class="form-control mb-3" required>
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Donor Password</label>
						<input type="text" name="dpassword" value="<?php echo $row['dpassword']; ?>" class="form-control mb-3" required minlength="6">
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Donor Phone Number</label>
						<input type="text" name="dphone" value="<?php echo $row['dphone']; ?>" class="form-control mb-3" required>
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Donor City</label>
						<input type="text" name="dcity" value="<?php echo $row['dcity']; ?>" class="form-control mb-3" required>
